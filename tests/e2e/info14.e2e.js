...
module.exports={title:"שלב 14 — דף המידע",tests:[
  ...
  /* «ריק» כאן הוא בלי נתונים שמורים. מסך פרטי הקשר עצמו הוא שלב פתיחה
     שה-harness עובר מראש עבור כל הבדיקות — הוא נבדק בנפרד ב-lead.e2e.js. */
  check("גם במכשיר בלי שום נתון שמור, שום דבר לא קופץ",fresh,async page=>{
