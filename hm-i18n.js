...
en:{
  ...
  "lead.sub":"A few details about you — not your students — so we can send you a short update and questionnaire later.",
  "lead.first":"First name",
  "lead.last":"Last name",
  "lead.contact":"Email or mobile",
  "lead.send":"Send and continue",
  "lead.skip":"Not now",
  "lead.note":"These details are sent directly to us to get in touch with you. Everything else — students, grades, measurements — stays on your device only, as always.",
  ...
  "home.moreSub":"school champions · students and grades · class tools · nutrition",
...
ar:{
  ...
  "lead.sub":"بضعة تفاصيل عنك أنت — وليس عن الطلاب — حتى نتمكن من إرسال تحديث قصير واستبيان لك لاحقًا.",
  "lead.first":"الاسم الأول",
  "lead.last":"اسم العائلة",
  "lead.contact":"البريد الإلكتروني أو الجوال",
  "lead.send":"إرسال ومتابعة",
  "lead.skip":"ليس الآن",
  "lead.note":"هذه التفاصيل تُرسل إلينا مباشرة للتواصل معك. كل شيء آخر — الطلاب والعلامات والقياسات — يبقى على جهازك فقط، كما كان دائمًا.",
  ...
  "home.moreSub":"أبطال المدرسة · الطلاب والعلامات · أدوات الصف · التغذية",
...
ru:{
  ...
  "lead.sub":"Немного данных о вас — не об учениках — чтобы мы могли позже прислать вам короткое обновление и анкету.",
  "lead.first":"Имя",
  "lead.last":"Фамилия",
  "lead.contact":"Email или телефон",
  "lead.send":"Отправить и продолжить",
  "lead.skip":"Не сейчас",
  "lead.note":"Эти данные отправляются напрямую нам, чтобы связаться с вами. Всё остальное — ученики, оценки, замеры — остаётся только на вашем устройстве, как и раньше.",
  ...
  "home.moreSub":"чемпионы школы · ученики и оценки · инструменты класса · питание",
