...
en:{
  ...
  "lead.sub":"The app is completely free — no credit card, no payment, no commitment. Just tell us who you are, so we can send you a short feedback questionnaire — that's what helps us improve the app going forward.",
...
ar:{
  ...
  "lead.sub":"التطبيق مجاني تمامًا — بدون بطاقة ائتمان، بدون دفع وبدون أي التزام. فقط قولوا لنا من أنتم، حتى نتمكن من إرسال استبيان قصير لرأيكم — وهذا ما يساعدنا على تطوير التطبيق مهنيًا قدمًا.",
...
ru:{
  ...
  "lead.sub":"Приложение полностью бесплатное — без банковской карты, без оплаты и без обязательств. Просто скажите нам, кто вы, чтобы мы могли прислать вам короткую анкету отзыва — это помогает нам профессионально развивать приложение дальше.",
