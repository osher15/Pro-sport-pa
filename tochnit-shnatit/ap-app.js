  ...
  $("#v-settings").innerHTML=`
   ...
   <section class="card"><h2>📅 חיבור ליומן</h2>
     ...
     <details class="prot"><summary>איך נרשמים ליומן חי</summary>
       <div class="row"><b>1</b><span>יומן גוגל במחשב ← בסרגל הימני «יומנים אחרים» ← <b>+</b> ← «הרשמה ליומן דרך כתובת URL».</span></div>
     ...
     <details class="prot"><summary>ייבוא חד־פעמי של קובץ</summary>
       <div class="row"><b>1</b><span>פותחים את יומן גוגל במחשב (לא בנייד — הייבוא לא קיים באפליקציה).</span></div>
